...
import * as gallery from "components/Pages/Gallery/gallerydata";
...
const profileData = {
  personalInfo: {
    ...
    'Emirates id': '656897',
    'Email': 'demo@dala.com',
    'Date of joining': '12/11/2020',
    'Gender': 'Male',
  },
  address: {
    'Present Address': "XYZ Street, Nigeria",
    'Permanent Address': "XYZ Street, Nigeria",
  }
}
            ...
            <Card.Body>
              <div className="panel profile-cover">
                <div className="profile-cover__img">
                  <img src={require("assets/dala-assets/img/Dala_1.jpg")} alt="img" />
                  <p>Change Picture</p>
                  <h3 className="h3">Dala User</h3>
                </div>
                      ...
                      <div className="main-content-body tab-pane p-sm-4 p-0 border-top-0 active">
                        <div className=" p-0 border p-0 rounded-10">
                          <div className="p-4">
                            ...
                            {
                              Object.keys(profileData.personalInfo).map((item, index) => (
                                <Row key={item} className="mb-3">
                                  <Col>{item}</Col>
                                  <Col>: {profileData.personalInfo[item]}</Col>
                                </Row>
                              ))
                            }
                          </div>
                          ...
                          <div className="p-4">
                            ...
                            {
                              Object.keys(profileData.address).map((item, index) => {
                                return (
                                  <div className="mb-3" key={item}>
                                    <h4 className="tx-14 mb-3">{item}</h4>
                                    <p>{profileData.address[item]}</p>
                                  </div>
                                )
                              })
                            }
