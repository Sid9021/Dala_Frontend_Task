  ...
  return (
    <div>
      ...
      <Form onSubmit={(e) => e.preventDefault()}>
        ...
        <button className="btn ripple btn-success btn-block mt-2" style={{width: "100px", height: "50px", marginLeft: "auto", marginBottom: "20px"}} type="submit" >
                                Submit
                              </button>
      </Form>
    </div>
